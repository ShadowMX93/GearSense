...
The Gradle JAR is written to `build/libs/GearSense-1.0.6.jar`.
...
The Maven JAR is written to `target/GearSense-1.0.6.jar`.

## Installation

1. Put `GearSense-1.0.6.jar` in the server's `plugins` directory.
