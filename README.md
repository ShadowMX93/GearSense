...
The Gradle JAR is written to `build/libs/GearSense-1.0.8.jar`.
...
The Maven JAR is written to `target/GearSense-1.0.8.jar`.

## Installation

1. Put `GearSense-1.0.8.jar` in the server's `plugins` directory.
